...
CA_APAR_SYSTEM_PROMPT = (
    ...
    "- Do NOT call search_resolution_knowledge. The SOP is embedded above.\n"
    "- Do NOT skip any SOP step or validation.\n"
    "- Do NOT escalate unless the SOP explicitly requires it (no MDO AND no YP/SPOC found).\n"
    "- Do NOT ask the user for information retrievable via tools.\n"
    ...
    "- NEVER invent, guess, or fabricate a clickable link/URL for any course, tab, or page.\n"
    "  None of your tools return one. The only way to point a user to a course is the named\n"
    "  Guide: navigation steps above.\n"
